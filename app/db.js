...
export const SYNC_STORES = new Set(['foods', 'meals', 'log', 'measurements', 'workouts', 'water', 'exercises', 'plans', 'photos']); // photos: metadata syncs here, the image itself goes to Storage (sync.js)
